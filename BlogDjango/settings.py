...
AWS_SECRET_ACCESS_KEY = os.path.join(BASE_DIR, 'key.txt')

AWS_STORAGE_BUCKET_NAME = 'django-bucket-ibk'

# AWS_ACCESS_KEY_ID = os.environ.get('AWS_KEY_ID', 'AKIAWZBUTVX5QK4PZM4Z')

AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_ACCESS_KEY', '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')
